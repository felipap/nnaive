...
var Board, Bot, Circle, Drawable, FixedPole, Food, GeneticEngine, NeuralNet, Neuron, NeuronLayer, Square, Triangle, calcNumWeights, dist, dist2, genEng, mod, painter, parameters, roundFloat, sigmoid, tic, _Bot, _ref, _ref1, _ref2, _ref3,
...
Bot = (function(_super) {
  ...
  function Bot(weights) {
    ...
    this.fitness = 0;
    this.nn = new NeuralNet(window.layersConf, 4);
    this.nn.putWeights(this.weights);
    console.log('here:', this.nn.fire([0, 0, 0, 0]));
    this.isTop = false;
  }
