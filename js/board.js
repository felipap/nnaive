...
var Board, Bot, Circle, Drawable, FixedPole, Food, GeneticEngine, NeuralNet, Neuron, NeuronLayer, Square, Triangle, dist, dist2, genEng, mod, painter, parameters, sigmoid, tic, _Bot, _ref, _ref1, _ref2, _ref3,
...
_Bot = (function(_super) {
  ...
  _Bot.prototype.tic = function(step) {
    var food, nangle, output, speed, _i, _len, _ref3;
    speed = 100;
    ...
    output = this.nn.update([this.closestFood.position.x - this.position.x, this.closestFood.position.y - this.position.y, Math.cos(this.angle), Math.sin(this.angle)]);
...
Neuron = (function() {
  function Neuron(nInputs) {
    var i;
    this.nInputs = nInputs != null ? nInputs : window.NPL;
  ...
  function NeuralNet(layersConf) {
    ...
    if (!layersConf) {
      this.layers = (function() {
        var _i, _ref4, _results;
        _results = [];
        for (i = _i = 0, _ref4 = window.NL; 0 <= _ref4 ? _i < _ref4 : _i > _ref4; i = 0 <= _ref4 ? ++_i : --_i) {
