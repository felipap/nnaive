...
var Board, Bot, CNeuralNet, Circle, Drawable, FixedPole, Food, SNeuron, SNeuronLayer, Square, Triangle, dist, dist2, mod, painter, _ref, _ref1, _ref2, _ref3,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

SNeuron = (function() {
  SNeuron.prototype.nInputs = 0;

  SNeuron.prototype.weights = [];

  function SNeuron(nInputs) {
    var i, weights, _i, _ref;
...
SNeuronLayer = (function() {
  SNeuronLayer.prototype.nNeurons = 0;

  SNeuronLayer.prototype.neurons = [];

  function SNeuronLayer(nNeurons, inputsPerNeuron) {
...
CNeuralNet = (function() {
  ...
  CNeuralNet.prototype.nInputs = 0;

  CNeuralNet.prototype.nOutputs = 0;

  CNeuralNet.prototype.nHiddenLayers = 0;
