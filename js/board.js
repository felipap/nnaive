...
var Board, Bot, Circle, Drawable, FixedPole, Food, GeneticEngine, NeuralNet, Neuron, NeuronLayer, Square, Triangle, calcNumWeights, dist, dist2, genEng, mod, painter, parameters, roundFloat, sigmoid, stats, _Bot, _ref, _ref1, _ref2, _ref3,
...
_Bot = (function(_super) {
  ...
  _Bot.prototype.tic = function(step) {
    var food, nangle, output, speed, _i, _len, _ref4;
    speed = 100;
    ...
    output = this.nn.fire([Math.atan2(this.closestFood.y - this.position.y, this.closestFood.x - this.position.x), this.angle]);
    nangle = output[0];
    this.angle += nangle;
...
GeneticEngine = (function() {
  var avgFitness, bestFitness, bestGenoma, crossover, genCounter, mutate, population, totalFitness, worstFitness;
  ...
  GeneticEngine.prototype.getChromoRoulette = function(population) {
    ...
    return console.log('não', _.reduce(population, function(a, b) {
...
Bot = (function(_super) {
  ...
  function Bot(weights) {
    ...
    this.fitness = 0;
    this.nn = new NeuralNet(window.layersConf, 2);
...
roundFloat = function(num, arg) {
  return Math.round(Math.pow(10, arg) * num) / Math.pow(10, arg);
};
