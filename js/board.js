...
var Board, Bot, Circle, Drawable, FixedPole, Food, NeuralNet, Neuron, NeuronLayer, Square, Triangle, colorConfig, dist, dist2, mm, mod, painter, _Bot, _ref, _ref1, _ref2, _ref3,
...
_Bot = (function(_super) {
  ...
  _Bot.prototype.tic = function(step) {
    var food, foodAngle, _i, _len, _ref4;
    this.closestFood = this.closestFood || game.board.food[0];
    this.closestFood.color = colorConfig.food;
    ...
    this.closestFood.color = colorConfig.selectedFood;
    if (Math.abs(this.position.y - this.closestFood.position.y) < 5) {
      foodAngle = Math.atan2(5, this.position.x - this.closestFood.position.x);
    } else {
      foodAngle = Math.atan2(this.position.y - this.closestFood.position.y, this.position.x - this.closestFood.position.x);
    }
    this.lastOutput = this.nn.fire([foodAngle - this.angle || 1]);
...
Bot = (function(_super) {
  ...
  Bot.prototype.render = function(context) {
    ...
    if (game.board.stats.topBot === this) {
      color = colorConfig.bestBot;
    } else if (this.isElite) {
      color = colorConfig.eliteBot;
    }
...
Board = (function() {
  ...
  Board.prototype.genRandBot = function() {
    ...
    return new Bot((function() {
      var _i, _ref4, _results;
      _results = [];
      for (i2 = _i = 0, _ref4 = this.params.numWeights; 0 <= _ref4 ? _i < _ref4 : _i > _ref4; i2 = 0 <= _ref4 ? ++_i : --_i) {
