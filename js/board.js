...
var Board, Bot, Circle, Drawable, FixedPole, Food, GeneticAlgorithm, Genoma, NeuralNet, Neuron, NeuronLayer, Square, Triangle, dist, dist2, generationCounter, mod, nn, output, painter, params, sigmoid, tic, ws, _ref, _ref1, _ref2, _ref3,
...
GeneticAlgorithm = (function() {
  var avgFitness, bestFitness, bestGenoma, cromossomes, crossoverRate, genCounter, mutationRate, totalFitness, worstFitness;
  ...
  function GeneticAlgorithm(popSize) {}
  ...
  GeneticAlgorithm.prototype.getChromoRoulette = function() {};

  GeneticAlgorithm.prototype.grabNBest = function(nBest, numCopies, vecPop) {};

  GeneticAlgorithm.prototype.calculateBestWorstAvgTotal = function() {};

  GeneticAlgorithm.prototype.reset = function() {};

  GeneticAlgorithm.prototype.epoch = function(oldPop) {};
