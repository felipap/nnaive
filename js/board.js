...
var Board, Bot, Circle, Drawable, FixedPole, Food, NeuralNet, Neuron, NeuronLayer, Square, Triangle, dist, dist2, mod, nn, output, painter, params, sigmoid, ws, _ref, _ref1, _ref2, _ref3,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

sigmoid = function(netinput, response) {
  return 1 / (1 + Math.exp(-netinput / 1));
};
  ...
  function Neuron(nInputs) {
    ...
    this.weights = (function() {
      ...
      for (i = _i = 0, _ref = this.nInputs; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        _results.push((window.counter++) + i / 10);
      }
      return _results;
    }).call(this);
  }
